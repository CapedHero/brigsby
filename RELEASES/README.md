...
of the reviewed release manifest, the staging-exporter version, and the
successful private and public CI runs. Release records deliberately contain no
private paths, instructions, experiments, or unreleased material.
